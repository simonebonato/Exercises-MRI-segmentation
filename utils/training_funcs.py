...
def training_setup(model: nn.Module,
    ...
    if Nit is not None:
        print(f'Nit is set to {Nit}, training will stop after {Nit} iterations each epoch...\n')
...
def training_loop(train_data_loader: torch.utils.data.DataLoader,
    ...
    model, scaler = training_setup(model, 
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), os.path.join(best_models_dir, f'best_model.pth'))
