...
def get_args():
    ...
    parser.add_argument("-train_from_checkpoint", help="Train from a checkpoint. Insert the path to the weights you wish to load", type=str, default=None)
    parser.add_argument("-fine_tune", help="Fine tune the model, training only the last layer and freezing the others.", type=bool, default=False)
    parser.add_argument("-best_models_dir", help="Directory where the best models will be saved", type=str, default='best_models')
    parser.add_argument("-mixed_precision", help="Use mixed precision for the training", type=bool, default=False)
    parser.add_argument("-Nit", help="Number of iterations for the training", type=int, default=None)
